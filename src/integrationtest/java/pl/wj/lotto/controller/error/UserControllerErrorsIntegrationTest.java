package pl.wj.lotto.controller.error;
...
public class UserControllerErrorsIntegrationTest extends BaseIntegrationTest {
    ...
    @Test
    void shouldReturnConflictWhenUserAlreadyExistsInDatabase() throws Exception {
