...
public class DrawConfig {
    @Bean
    public DrawServicePort drawServicePort(DrawRepositoryPort drawRepositoryPort, DrawTimeChecker drawTimeChecker) {
        DrawService drawService = new DrawService(drawRepositoryPort, drawTimeChecker);
